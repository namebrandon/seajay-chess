#!/bin/bash
# External Validation: Stage 14 Final vs Stash v10 - From Starting Position
# Purpose: Establish baseline performance against external engine from startpos
...
# Test configuration
OUTPUT_DIR="/workspace/sprt_results/external_stage15_validation/stage14_vs_stash_startpos_$(date +%Y%m%d_%H%M%S)"
...
echo "================================================"
echo "Stage 14 has the White bias bug (85-95% White wins in self-play)"
echo "Behavior against external engines may differ"
echo ""
...
"$FASTCHESS" \
    ...
    -recover \
    -event "Stage 14 vs Stash v10 External Validation (Startpos)" \
