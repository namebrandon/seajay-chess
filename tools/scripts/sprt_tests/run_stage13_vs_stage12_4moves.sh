#!/bin/bash
# SPRT Test: Stage 13 (Iterative Deepening) vs Stage 12 (baseline) - With Opening Book
...
OUTPUT_DIR="$PROJECT_ROOT/sprt_results/SPRT-Stage13-vs-Stage12-4moves-$TIMESTAMP"
mkdir -p "$OUTPUT_DIR"
...
echo "==================================================================="
echo "SPRT Test: Stage 13 (Iterative Deepening) vs Stage 12 (TT) - 4MOVES"
echo "==================================================================="
...
SPRT Test: Stage 13 vs Stage 12 (4moves book)
==============================================
Date: $(date)
