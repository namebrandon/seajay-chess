...
TEST_NAME="SPRT-Stage14v13-4moves-60s-${TIMESTAMP}"
...
Opening Book: 4moves_test.pgn
Expected Result: H1 accepted (+60-150 Elo improvement)
Note: Longer time control for more accurate measurement
Features Tested:
...
echo "Time Control: ${TIME_CONTROL} (tournament TC)"
echo "SPRT Bounds: [${ELO0}, ${ELO1}] ELO"
echo "Hypothesis: Stage 14 should gain 60+ ELO from quiescence"
echo "Output: ${RESULT_DIR}/games.pgn"
echo "======================================"
echo ""
echo "WARNING: This test will take several hours due to"
echo "the longer time control. Consider running overnight."
echo ""
echo "Estimated duration: 6-12 hours (60-120 games/hour)"
echo ""
