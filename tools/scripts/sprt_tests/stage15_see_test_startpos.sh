#!/bin/bash
# Stage 15 SEE SPRT Test - From Starting Position
# Tests Stage 15 SEE implementation against Stage 14 baseline
# Expected: +30-50 ELO improvement

echo "================================================"
echo "Stage 15 SEE SPRT Test - From Starting Position"
echo "================================================"
echo ""
...
OUTPUT_DIR="/workspace/sprt_results/stage15_see_startpos"
...
# Use fast-chess for SPRT from startpos
"$FASTCHESS" \
