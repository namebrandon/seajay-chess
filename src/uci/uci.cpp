...
void UCIEngine::handleUCI() {
    ...
    std::cout << "option name EvalThreatHangingPawn type spin default 57 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatHangingKnight type spin default 63 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatHangingBishop type spin default 7 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatHangingRook type spin default 38 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatHangingQueen type spin default 52 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatDoublePawn type spin default 22 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatDoubleKnight type spin default -20 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatDoubleBishop type spin default 0 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatDoubleRook type spin default 14 min -64 max 64" << std::endl;
    std::cout << "option name EvalThreatDoubleQueen type spin default -7 min -64 max 64" << std::endl;
    ...
    std::cout << "option name EvalPasserPhalanxRookBonus type spin default 4 min 0 max 64" << std::endl;
    std::cout << "option name EvalCandidateLeverBaseBonus type spin default 5 min 0 max 32" << std::endl;
    std::cout << "option name EvalCandidateLeverAdvanceBonus type spin default 9 min 0 max 32" << std::endl;
    std::cout << "option name EvalCandidateLeverSupportBonus type spin default 5 min 0 max 32" << std::endl;
    std::cout << "option name EvalCandidateLeverRankBonus type spin default 4 min 0 max 16" << std::endl;
