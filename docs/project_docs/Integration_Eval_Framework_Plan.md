...
5. **`feature/eval-framework/pawn-candidate-levers` – Candidate/lever logic:** Implementation complete; next step is to validate lever telemetry on the pawn pack and bundle the new knobs into the upcoming SPSA batch.
