...
- 2025-10-11: Remaining regression cases are search-bound. Depth-18 search on `r3r1k1/pp1q1pp1/...` still outputs −112 cp even though the static eval is +190 cp (`docs/project_docs/telemetry/eval_bias/eval_extended_r3r1k1.txt`), indicating follow-up work is needed on move ordering / pruning gates to capitalise on the stronger heuristic signal.
