...
3. **Phase 1 — King Safety**
   ...
   - [2025-10-02] SPRT #686 vs. integration failed (−37 Elo); current branch now tones down loose-king penalties (20/25 scale) and applies quadratic attack-unit growth before next test.
